  ...
  return (
    <div>
      ...
      <div className="pt-36 font-sans">
        ...
        <div className="lg:flex lg:gap-8 space-y-8 lg:space-y-0 pt-4">
          <div className="border-2 border-yellow-400 shadow-xl bg-slate-700 p-8 rounded-lg lg:w-1/4">
            Image
          ...
          <div className="border-2 border-yellow-400 shadow-xl bg-slate-700 p-8 rounded-lg lg:w-1/4">
            ...
            <p className="text-sm text-center break-words">
              Have ETH in your wallet to switch to $XONG. If you don’t have any
